...
<font size="+1">
<p>This is a report to show the frequency of using each lecturer room.</p>
<?php
$sql = 'SELECT  Room_ID ,  COUNT(*) AS Frequency_of_Room_ID
FROM  booking
GROUP BY Room_ID';
...
<th align='center'>Frequency of Room ID</th>
</tr>";
echo "</tr>";
while($row = mysqli_fetch_array($result)){
	echo "<tr>";
	echo "<td align='center'>".$row['Room_ID']."</td>";
	echo "<td align='center'>".$row['Frequency_of_Room_ID']."</td>";
	echo "</tr>";
};
echo "</table>";
mysqli_close($con);
