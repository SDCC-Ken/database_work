...
<font size="+1">
<p>This is a report to show the most highest frequency of using the lecturer room</p>
<?php
$sql = 'SELECT  Room_ID ,  COUNT(*) AS Frequency
FROM  booking
GROUP BY Room_ID
HAVING Room_ID <= ALL (SELECT  Room_ID FROM  booking) ';
