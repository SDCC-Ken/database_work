...
<font size="+1">
<p>It is a report to show the courses that the students are studying</p>
<?php
$sql = 'SELECT   a.Student_ID, a.Student_Name, b.Lesson_Code, c.Lesson_Name
FROM      student a, enroll_of_lesson b, lesson c
WHERE   a.Student_ID = b.Student_ID
AND        b.Lesson_Code = c.Lesson_Code
GROUP BY a.Student_ID, Student_Name, b.Lesson_Code, Lesson_Name, Grade
