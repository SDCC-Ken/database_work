...
<font size="+1">
<p>This is a report to show the frequency of using the lecturer room in each day.</p>
<?php
$sql = 'SELECT  Booking_Date ,  COUNT(*) AS Frequency_of_Booking_Date
FROM  booking
...
<th align='center'>Frequency of Booking Date</th>
</tr>";
echo "</tr>";
while($row = mysqli_fetch_array($result)){
	echo "<tr>";
	echo "<td align='center'>".$row['Booking_Date']."</td>";
	echo "<td align='center'>".$row['Frequency_of_Booking_Date']."</td>";
	echo "</tr>";
};
echo "</table>";
mysqli_close($con);
