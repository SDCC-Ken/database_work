...
<font size="+1">
<p>Find out the number of the booking booked by lecturer.</p>
<?php
$sql = 'Select a.Lecturer_ID , b.Lecturer_LastName, b.Lecturer_FirstName,count(*) as No_booking_by_lecturer 
from booking a, lecturer b
where a.Lecturer_ID=b.Lecturer_ID
and a.Lecturer_ID is not null
group by a.Lecturer_ID';
...
<th align='center'>Number of booking</th>
</tr>";
echo "</tr>";
while($row = mysqli_fetch_array($result)){
	...
	echo "<td align='center'>".$row['No_booking_by_lecturer']."</td>";
	echo "</tr>";
};
echo "</table>";
mysqli_close($con);
