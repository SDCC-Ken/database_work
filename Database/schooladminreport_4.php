...
<font size="+1">
<p>Find out the number of the booking booked by Club.</p>
<?php
$sql = 'Select a.Club_ID, b.Club_Name , count(*) as No_booking_by_club
from booking a, club b
...
while($row = mysqli_fetch_array($result)){
	echo "<tr>";
	echo "<td align='center'>".$row['Club_ID']."</td>";
	echo "<td align='center'>".$row['Club_Name']."</td>";
	echo "<td align='center'>".$row['No_booking_by_club']."</td>";
	echo "</tr>";
};
echo "</table>";
mysqli_close($con);
