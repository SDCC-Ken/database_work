...
<font size="+1">
<form id="form1" name="form1" method="post" action="student_Check_enroll_lesson_and_grade.php">
<p align="center">New enroll lesson form</p>
<p>Lesson Code:<input type="text" name="LC" value="<?php echo $_POST['LC']; ?>" maxlength="7" /></p>
<p>Student ID:<?php echo $SID; ?><input type="text" name="SID" value="<?php echo $SID; ?>" maxlength="9" hidden="-1" /></p>
