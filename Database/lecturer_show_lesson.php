...
<iframe width="100%" height="700" frameborder="0" scrolling="no" src="menu_l.html"></iframe>
</td>
<td width="80%" align="left" valign="top">
<font size="+1">
<p>You can check the lesson's information by Lesson ID.</p>
<form id="form1" name="form1" method="post" action="lecturer_show_lesson.php">
<p>Lesson ID:<input type="text" name="LCode" value="<?php echo $_POST['LCode']; ?>" maxlength="9" /></p>
<p><input type="submit" name="Check" id="Check" value="GO" /></p>
</form>
<?php
$SQL1 =  "SELECT * FROM lesson WHERE Lesson_Code = '".$_POST['LCode']."'";
...
if($_POST['Check']=="GO"){
			...
			<th align='center'>Lesson Division</th>
			...
			while($row = mysqli_fetch_array($result1)){
				...
				echo "<td align='center'>".$row['Lesson_Division']."</td>";
