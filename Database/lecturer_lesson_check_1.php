...
<font size="+1">
<form id="form1" name="form1" method="post" action="lecturer_lesson_check_1.php">
<p>You can check the lesson by lesson Division</p>
...
<?php
if($_POST['Check']=="GO"){
	$SQL = "SELECT 	Lesson_Code, Lesson_Name, Lesson_Division
			FROM             lesson
			WHERE 	Lesson_Division = '".$_POST['LD']."';";
