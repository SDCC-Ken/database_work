...
<font size="+1">
<form action="school_admin_check_student_join_club.php" method="post">
<p>You can find out the student that is in a specific club</p>
<p>Club ID:<input type="text" name="CID" value="<?php echo $_POST['CID']; ?>" /></p>
<p><input type="submit" name="Check" id="Check" value="GO" /></p>
</form>
<?php
if($_POST['Check']=="GO"){
$SQL1="Select     a.Student_ID, a.Student_Name
		From      student a, enroll_of_club b, club c
		WHERE      a.Student_ID= b.Student_ID
		and       b.Club_ID= c.Club_ID
		and       b.Club_ID= ".$_POST['CID']."
		Order by  Student_ID; ";
