...
if (!$result1) {
    echo "Query ERROR!";
		...
		if($result = mysqli_query($con,$SQL4)){
			...
			echo "<tr>
			<th align='center'>Lesson Date</th>
			<th align='center'>Lesson Start Time</th>
			<th align='center'>Lesson End Time</th>
